...
export default function TodosDetails() {
  ...
  return (
    <div className="detail-page min-h-screen p-6 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white"
      style={{ minHeight: "100vh" }}>
      <h1 className="text-3xl font-bold mb-4 ">Todo Details</h1>

      <div className="
        bg-white text-gray-900 dark:bg-gray-900 w-100 md:!w-75 p-3 md:!p-6 rounded-xl border border-gray-200 dark:border-gray-700">
